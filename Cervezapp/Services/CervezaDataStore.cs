...
new Cerveza() {
    ...
    Steps = new List<Step>() {
        ...
        } // Aquí puedo continuar con más Steps
    }
},
new Cerveza() {
    Id = 2,
    Name = "Belga Roja",
    Description = "Una cerveza roja dulce, con capa de espuma blanca y cremosa.",
    Steps = new List<Step>() {
        new Step() {
            Id = 0,
            Title = "IMPORTANTE",
             ...
             DescriptionPart = new DescriptionPart
                        {
                            ...
                            Items = new List<string> 
                            {
                                "4kg de Belgian Red dentro de bolsa maceradora",
                                "Olla de 20 litros llena de agua",
                                "Cuchara de madera",
                                "Termómetro"
                            }
